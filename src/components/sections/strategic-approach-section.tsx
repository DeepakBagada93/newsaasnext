...
export default function StrategicApproachSection() {
  return (
    <section id="strategic-approach" className="w-full py-16 md:py-24 bg-card/10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Our Strategic Approach to Digital Success
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            We follow a proven, collaborative methodology to transform your vision into reality, ensuring every project delivers impactful and measurable results.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
         ...
         <div className="mt-16 text-center p-8 bg-primary/5 rounded-lg shadow-md">
          <h3 className="text-2xl font-bold text-primary mb-6">What Sets Our Approach Apart?</h3>
